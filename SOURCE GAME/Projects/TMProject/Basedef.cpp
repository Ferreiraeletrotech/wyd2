...
{
    float sc = (float)((float)g_pDevice->m_dwScreenWidth * (float)(size / 1366.0f));
    if ((float)g_pDevice->m_dwScreenWidth == 800 || (float)g_pDevice->m_dwScreenWidth == 640 || (float)g_pDevice->m_dwScreenWidth == 1024 || (float)g_pDevice->m_dwScreenWidth == 1280) {
        sc = (float)((float)g_pDevice->m_dwScreenWidth * (float)(size / 800.0f));
    }
    return sc;
}
...
int BASE_InitializeServerList()
{
    ...
    snprintf(g_pServerList[0][0], 64, "http://26.102.91.166/"); //Link da barra
    snprintf(g_pServerList[0][1], 64, "26.102.91.166");

    //snprintf(g_pServerList[1][0], 64, "http://26.102.91.166/"); //Link da barra
    //snprintf(g_pServerList[1][1], 64, "108.165.179.162");
...
{
    if (effect.cEffect == 43 || (effect.cEffect >= 115 && effect.cEffect <= 126))
        return true;
