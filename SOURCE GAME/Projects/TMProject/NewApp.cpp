...
HRESULT NewApp::Initialize(HINSTANCE hInstance, int nFull)
{
	...
	stResList[1].dwWidth = 640;
	stResList[1].dwHeight = 480;
	stResList[1].dwBit = 32;

	stResList[2].dwWidth = 800;
	stResList[2].dwHeight = 600;
	stResList[2].dwBit = 32;

	stResList[3].dwWidth = 1366;
	stResList[3].dwHeight = 768;
	stResList[3].dwBit = 32;

	stResList[4].dwWidth = 1600;
	stResList[4].dwHeight = 900;
	stResList[4].dwBit = 32;

	stResList[5].dwWidth = 1920;
	stResList[5].dwHeight = 1080;
	stResList[5].dwBit = 32;

	stResList[6].dwWidth = 2560;
	stResList[6].dwHeight = 1440;
...
void NewApp::InitServerName()
{
	...
	snprintf(g_szServerNameList[0], 11, "Canal");

	//Servidores (decrescente)
	snprintf(g_szServerNameList[1], 11, "Oficial");
	snprintf(g_szServerNameList[2], 11, "Teste");
