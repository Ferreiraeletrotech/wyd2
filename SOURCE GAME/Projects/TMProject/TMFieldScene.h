...
public:
	...
	int OnPacketReconnectParty(MSG_STANDARD* pStd);
	int OnPacketSendBattlePass(MSG_STANDARD* pStd);
	int OnPacketSendArenaReal(MSG_STANDARD* pStd);
	int OnPacketSendNpc(MSG_STANDARD* pStd);
	int OnAccel(int nMsg) override;

	int CheckItemQntCarry(STRUCT_ITEM Item);
	int CheckSameItemCarry(STRUCT_ITEM Item);
	...
	int OnPacketSendInfoPlayer(MSG_STANDARD* pStd);
