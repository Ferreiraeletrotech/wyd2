...
#define IDC_RELOADNEWCOMPOSITOR 9009
...
#define		MESSAGEWHISPER_LENGTH	256
...
struct STRUCT_RECENTCONNECTION
{
	unsigned int IP;
...
const short	 _MSG_UpdateFilterList = (258 | FLAG_GAME2CLIENT | FLAG_CLIENT2GAME);
struct		  MSG_UpdateFilterList
{
	_MSG;
	int Item[16];
};
...
const short	 _MSG_SendBattlePass = (295 | FLAG_GAME2CLIENT | FLAG_CLIENT2GAME);
struct MSG_SendBattlePass
{
	_MSG;
	STRUCT_ITEM Item[10];
	int Points;
...
const short	 _MSG_ReqNPC = (293 | FLAG_GAME2CLIENT | FLAG_CLIENT2GAME);
struct MSG_ReqNPC
{
	_MSG;
	int NPCID;
...
const short	 _MSG_SendNPC = (294 | FLAG_GAME2CLIENT | FLAG_CLIENT2GAME);
struct MSG_SendNPC
{
	_MSG;
	STRUCT_ITEM Item[16];
...
const short	 _MSG_SendArenaReal = (303 | FLAG_GAME2CLIENT | FLAG_CLIENT2GAME);
struct		  MSG_SendArenaReal
{
	_MSG;
	int Kills[4];
};
...
const short	 _MSG_ReconnectGrupo = (302 | FLAG_GAME2CLIENT | FLAG_CLIENT2GAME);
struct		  MSG_ReconnectGrupo
{
	_MSG;
	int Index;
	char Nick[16];
};
const short	 _MSG_RequestInfoPlay = (292 | FLAG_GAME2CLIENT | FLAG_CLIENT2GAME);
struct MSG_RequestInfoPlay
{
	_MSG;
