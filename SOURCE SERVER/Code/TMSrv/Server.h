...
extern int cStoreItens[10][5][15][3];
...
extern int Desafiantes[2];
extern int ApostaTimer;

extern int bPassMissionsPoints[50];
extern STRUCT_ITEM BattlePassItens[50];
...
extern STRUCT_PARTIES Parties[200];
...
extern CUser pUser[MAX_USER];
extern CMob pMob[MAX_MOB + MAX_USER + 200];
...
extern std::vector<STRUCT_RECENTCONNECTION> BlackList;
////////////////////////////////////
