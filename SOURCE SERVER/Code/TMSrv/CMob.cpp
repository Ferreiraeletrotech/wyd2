...
//Huntress
		...
		if (MOB.Class == 2) {
			...
			{
				if (Evo == MORTAL) {
					MOB.CurrentScore.MaxHp += 600;
					MOB.CurrentScore.Ac += 180;
					//MOB.Magic += 0;
				}
				if (Evo == ARCH) {
					MOB.CurrentScore.MaxHp += 1200;
					MOB.CurrentScore.Ac += 350;
					//MOB.Magic += 0;
				}
				if (Evo >= CELESTIAL) {
					MOB.CurrentScore.MaxHp += 1700;
					MOB.CurrentScore.Ac += 550;
					//MOB.Magic += 0;
				}
			}
		}
		...
		if (MOB.Class == 0) {
			...
			if (MOB.LearnedSkill & 128 || MOB.LearnedSkill & 8388608)
			{
				if (Evo == MORTAL) {
					MOB.CurrentScore.MaxHp += 500;
					MOB.CurrentScore.Ac += 230;
					//MOB.Magic += 0;
				}
				if (Evo == ARCH) {
					MOB.CurrentScore.MaxHp += 1100;
					MOB.CurrentScore.Ac += 380;
					//MOB.Magic += 0;
				}
				if (Evo >= CELESTIAL) {
					MOB.CurrentScore.MaxHp += 1500;
					MOB.CurrentScore.Ac += 480;
					//MOB.Magic += 0;
				}
			}
			// Trans
			...
			{
				if (Evo == MORTAL) {
					MOB.CurrentScore.Damage += 250;
					MOB.CurrentScore.Ac += 200;
				}
				if (Evo == ARCH) {
					MOB.CurrentScore.Damage += 450;
					MOB.CurrentScore.Ac += 300;
				}
				if (Evo >= CELESTIAL) {
					MOB.CurrentScore.Damage += 650;
					MOB.CurrentScore.Ac += 400;
				}
			}
		}
