...
void UpdateShopDonate4() {
	...
	sprintf(hQuery, "SELECT * FROM `donatestore4` LIMIT 75");
	MYSQL_ROW row;
	MYSQL* wSQL = pc.wStart();
	MYSQL_RES* result = pc.wRes(wSQL, hQuery);
...
void UpdateShopDonate5() {
	...
	sprintf(hQuery, "SELECT * FROM `donatestore5` LIMIT 75");
	MYSQL_ROW row;
	MYSQL* wSQL = pc.wStart();
	MYSQL_RES* result = pc.wRes(wSQL, hQuery);
...
void UpdateShopDonate6() {
	...
	sprintf(hQuery, "SELECT * FROM `donatestore6` LIMIT 75");
	MYSQL_ROW row;
	MYSQL* wSQL = pc.wStart();
	MYSQL_RES* result = pc.wRes(wSQL, hQuery);
...
void UpdateShopDonate7() {
	...
	sprintf(hQuery, "SELECT * FROM `donatestore7` LIMIT 75");
	MYSQL_ROW row;
	MYSQL* wSQL = pc.wStart();
	MYSQL_RES* result = pc.wRes(wSQL, hQuery);
...
void UpdateShopDonate8() {
	...
	sprintf(hQuery, "SELECT * FROM `donatestore8` LIMIT 75");
	MYSQL_ROW row;
	MYSQL* wSQL = pc.wStart();
	MYSQL_RES* result = pc.wRes(wSQL, hQuery);
...
void UpdateShopDonate9() {
	...
	sprintf(hQuery, "SELECT * FROM `donatestore9` LIMIT 75");
	MYSQL_ROW row;
	MYSQL* wSQL = pc.wStart();
	MYSQL_RES* result = pc.wRes(wSQL, hQuery);
...
void UpdateShopDonate10() {
	...
	sprintf(hQuery, "SELECT * FROM `donatestore10` LIMIT 75");
	MYSQL_ROW row;
	MYSQL* wSQL = pc.wStart();
	MYSQL_RES* result = pc.wRes(wSQL, hQuery);
