...
bool AgroupList(int conn, int itemId)
{
	...
	if (pMob[conn].MOB.Equip[13].sIndex == 3901 || pMob[conn].MOB.Equip[13].sIndex == 3902 || pMob[conn].MOB.Equip[13].sIndex == 3916) {
		...
		int List[] = {
			...
			2394, //Âmago_de_Urso
			5972, //Fragmento_de_Refinação
			5973, //Fragmento_da_Proteção
			...
			4026, //Moeda_de_1kk
				...
				5982, //Fragmento_de_Runas
				5983, //Fragmento_de_Adamantita
				5776, //Fragmento_da_Evolução
				5777, //Fragmento_do_Avatar
				5778, //Fragmento_do_Artesão
				5779, //Fragmento_da_Fada
				5780, //Fragmento_de_Sephirot
				5782, //Fragmento_Gélido
				...
				5769, //Griupan_Frag
				5770, //Griupan_Frag
				5771, //Ovo_de_Páscoa_I
				5772, //Ovo_de_Páscoa_II
				5773, //Ovo_de_Páscoa_III
				5774, //Ovo_de_Páscoa_IV
				5775, //Ovo_de_Páscoa_V
				5776, //Fragmento_da_Evolução
				5777, //Fragmento_do_Avatar
				5778, //Fragmento_do_Artesão
				...
				5825, //Fragmento_da_Escuridão
				5826, //Estilhaço_da_Memória
				5827, //Memória_do_Artesão
				5830, //Livro_de_Encantamentos
				5831, //Poeira_de_Infirmus
				5834, //Pedra_Mortal
				5835, //Pó_de_Fada
				5836, //Página_do_Livro_de_Relíquias
				5837, //Poção_do_Alquimista
				5840, //Baú_Místico(N)
				5841, //Baú_Místico(M)
				5842, //Baú_Místico(A)
				5843, //Baú_Místico(Le)
