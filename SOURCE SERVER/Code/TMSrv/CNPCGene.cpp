...
void CNPCGenerator::DropList()
{
	...
	for (int i = 0; i < NumList; i++)
	{
		...
		for (int x = 0; x < MAX_CARRY; x++) {
			if (MOB->Carry[x].sIndex != 0)//drop vazio
				EmptyMob = 1;
		}
		...
		{	
			...
			//Carta N
			else if (i >= 2391 && i <= 2400)
			{ 
				region = 9;
			}
			//Carta M
			else if (i >= 2401 && i <= 2410)
			{
				region = 10;
			}
			//Carta A
			else if (i >= 2411 && i <= 2420)
			{
				region = 11;
			}
			...
			//Pista
			else if (i >= 4161 && i <= 4270)
			{
				region = 13;
			}
			//Pista
			else if (i >= 4211 && i <= 4215)
			{
				region = 13;
			}
			//Pista
			else if (i >= 4295 && i <= 4301)
			{
				region = 13;
			}
			//Pista
			else if (i >= 4475 && i <= 4481)
			{
				region = 13;
			}
			//Pista
			else if (i >= 4355 && i <= 4404)
			{
				region = 13;
			}
			//Pista
			else if (i >= 4406 && i <= 4411)
			{
				region = 13;
			}
			//Pista
			else if (i >= 4276 && i <= 4281)
			{
				region = 13;
